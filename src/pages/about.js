					...
					<div className="values-container">
						<div className="values-card">
							...
							<span className="values-text-slide">
								...
								product and plan to make lives easier and simpler as we go
								along.
							</span>
							<img
								src={PurplePlus}
						...
						<div className={isActive ? "values-card active" : "values-card"}>
							...
							<span className="values-text-slide">
								I am a strong believer in building collaborative relationships
								and working towards a common goal through developing creative
								and disruptive ideas that impact businesses positively.
							</span>
							<img
								src={PurplePlus}
								alt="Plus icon"
